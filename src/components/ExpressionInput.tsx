...
import { Play, RotateCcw, Code, Lightbulb } from 'lucide-react';
...
export const ExpressionInput = ({
  ...
  return <Card className="academic-panel">
      <CardHeader>
      ...
      <CardContent className="space-y-4">
        <div>
          ...
          <Select value={selectedExample} onValueChange={handleExampleSelect}>
            ...
            <SelectContent>
              {currentExamples.map(example => <SelectItem key={example.name} value={example.name}>
        ...
        {selectedExample && <div className="p-3 bg-algorithm rounded-lg">
